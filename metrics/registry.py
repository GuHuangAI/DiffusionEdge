...
from metrics.datasets import TransformPILtoRGBTensor, Cifar10_RGB, STL10_RGB
from metrics.feature_extractor_base import FeatureExtractorBase
# from torch_fidelity.feature_extractor_inceptionv3 import FeatureExtractorInceptionV3
from metrics.feature_extractor_inceptionv3 import FeatureExtractorInceptionV3_new, FeatureExtractorInceptionV3
from metrics.helpers import vassert
from metrics.noise import random_normal, random_unit, random_uniform_0_1, batch_lerp, batch_slerp_any, \
    batch_slerp_unit
from metrics.sample_similarity_base import SampleSimilarityBase
from metrics.sample_similarity_lpips import SampleSimilarityLPIPS
...
# register_feature_extractor('inception-v3-compat', FeatureExtractorInceptionV3_new)
